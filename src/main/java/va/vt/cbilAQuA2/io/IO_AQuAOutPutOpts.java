...
public class IO_AQuAOutPutOpts extends SwingWorker<Void, Integer>{
	...
	public IO_AQuAOutPutOpts(ImageDealer imageDealer, String savePath) {
	...
	protected Void doInBackground(){
		...
		try {
			Helper.writeObjectToFile(savePath, opts);
